// Noise3D chunk from Cabbibo
// https://github.com/cabbibo/wombs/blob/8ebd5f5c527318262e5edc9e26de135fd6fdfd13/js/Wombs/Utils/Shaders/shaderChunks.js#L314
...
void main() {
  ...
  vDisplacement = snoise3(offset) + 1.0;
